...
describe Salus::Config do
  ...
  let(:custom_info_hash_config_file)        { File.read('spec/fixtures/config/custom_info_hash.yaml') }
  let(:custom_info_string_config_file)        { File.read('spec/fixtures/config/custom_info_string.yaml') }
